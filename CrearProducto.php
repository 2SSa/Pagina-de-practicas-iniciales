...
<div class="container">
		...
		<div class="row">
  			<div class="col-md-4"><h3>Datos del producto</h3></div>  			
  			<div class="col-md-4"></div>							
		</div>
		
		<?php 
		$edita = null;
		$edita = $_GET['idProducto'];
			...
			if($edita == null){
  			...
  			<div class=\"row\">
				...
				<div class=\"col-xs-12 col-md-8\">
    				...
    				<input type=\"text\" class=\"form-control form-control-lg\" id=\"nombre\" placeholder=\"nombre del producto\" name=\"nombre\" required=\"\">
  					</div>
				</div>				
			</div>
			...
			<div class=\"row\">
				...
				<div class=\"col-xs-12 col-md-8\">
    				...
    				<input type=\"text\" class=\"form-control form-control-lg\" id=\"precio\" placeholder=\"Precio del producto\" name=\"precio\" required=\"\">
  					</div>
				</div>				
			</div>
			<div class=\"row\">    
			...
			";
				...
				<input type=\"text\" class=\"form-control form-control-lg\" id=\"idProducto\" name=\"idProducto\" required=\"\" readonly=\"readonly\" value=\"$id\">
  					</div>
				</div>				
			</div>
			...
			<div class=\"row\">
				...
				<div class=\"col-xs-12 col-md-8\">
					<div class=\"form-group\">
    				<label for=\"exampleFormControlInput2\">Precio</label>
    				<input type=\"text\" class=\"form-control form-control-lg\" id=\"precio\" placeholder=\"Precio del producto\" name=\"precio\" required=\"\" value=\"$precio\">
  					</div>
				</div>				
			</div>
