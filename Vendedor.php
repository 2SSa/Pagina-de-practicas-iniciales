...
<nav class="navbar navbar-expand-lg navbar-light " style="background-color:#96cf07;">
    ...
    <a href="CrearVendedor.php?idVendedor=">Crear</a>
            <?php
            ...
            echo "<table class='table table-striped'>
                ...
                $contenido = "";
                $resultado=mysqli_query($conexion,"SELECT* FROM $vendedor");
                ...
                for ($num_fila = $resultado->num_rows - 1; $num_fila >= 0; $num_fila--) {
                    ...
                    <td>".$fila['Nombre']."</td>
                    <td>". $fila['Telefono'] ."</td>
                    <td><a href=\"accionesV.php?idVendedor=".$fila['Codigo']."\">Actualizar</a> | <a href=\"accionesV.php?identificador=".$fila['Codigo']."\">Eliminar</a> </td>
                    </tr>";
